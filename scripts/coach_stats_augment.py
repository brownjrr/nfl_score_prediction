...
def get_games_dataframe():
    df = pd.read_csv(script_dir+"../data/teams.csv")
...
def get_play_by_play_table():
    ...
    df = pd.read_csv(script_dir+"../data/play_by_play_extended_v2.csv")
...
def get_coaches_table():
    df = pd.read_csv(script_dir+"../data/coaches.csv")
    return df

def get_game_level_coach_data():
    df = pd.read_csv(script_dir+"../data/game_level_coach_data.csv")
    return df
...
def create_additional_coach_stats():
    ...
    merged_df.to_csv(script_dir+"../data/game_level_coach_data_extended.csv", index=False)
